...
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) # добавлено
...
SECRET_KEY = 'django-insecure-24vg458z1sec7$o(_1o54k@0wj)!n)i83y6f4joa-=5x%)9*$i'
...
TELEGRAM_TOKEN = '8740944994:AAE6HOJzV5qRIncQtZkimBmtse5j7o-TEmU'
